...
examples/output: src/uk_cross_government_metadata_exchange_model/schema/uk_cross_government_metadata_exchange_model.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/uk_cross_government_metadata_exchange_model/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
